...
def get_default_data_paths():
	return { 'train': "./data_json/train2014.json", 'val': "./data_json/val2014.json"  }

def get_default_processed_data_paths():
	return { 'train': "./data_json/train2014.csv", 'val': "./data_json/val2014.csv" }
...
def process_json(data_filename):
	if data_filename is None:
		data_filename = get_default_data_paths()['train']
